...
public:
	...
	/* Печатает всех студентов без оценки 3 */
	...
	/* Печатает всех студентов без оценки 3 или 4 */
	...
	/* Печатает всех студентов без оценки 5 */
	...
	/* Печатает всех студентов без оценки 3 или 5 */
	...
	/* Печатает всех студентов без оценки 4 или 5 */
	...
	/* Меню выбора способа фильтрации по оценкам */
	void filterStudents()
	{
		...
		ClassEdit* ce = new  ClassEdit();
		ExamsResultsClass* erc = new ExamsResultsClass();
		filterStudMenu->addItem("Выход");   //0
		filterStudMenu->addItem("Получить список студентов, у которых нет оценки 3"); //1
		filterStudMenu->addItem("Получить список студентов, у которых нет оценки 3 или 4");   //2
		filterStudMenu->addItem("Получить список студентов, у которых нет оценки 5");   //3
		filterStudMenu->addItem("Получить список студентов, у которых нет оценки 3 или 5");   //4
		filterStudMenu->addItem("Получить список студентов, у которых нет оценки 4 или 5");   //5

		while (resultFilterStudMenu != exitFilterStudMenu) {
			filterStudMenu->eraseTitle();
			filterStudMenu->addTitleItem("Получить список студентов для которых выполнено условие");
			filterStudMenu->run();
	...
	void mainMenu() {
		...
		mainMenu->addItem("Выполнить вариант 02 (фильтр студентов по оценкам)"); //8
